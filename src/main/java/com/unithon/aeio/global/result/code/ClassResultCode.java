...
public enum ClassResultCode implements ResultCode {
    ...
    GET_PRACTICE_LIST(200, "SC009", "특정 멤버의 운동 날짜 리스트를 조회했습니다."),
    LIKE_LIST(200, "SC008", "사용자가 좋아요한 클래스의 목록을 조회했습니다."),
    ...
    GET_PRACTICE_LIST_BY_MONTH(200, "SC015", "특정 년-월의 운동 날짜 리스트를 조회했습니다."),
    ;
